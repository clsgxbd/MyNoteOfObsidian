...
```
执行成功后会出现 Authtoken saved to configuration file: C:\Users\xxx\AppData\Local/ngrok/ngrok.yml
...
ccount                       damu (Plan: Free)
ersion                       3.20.0
egion                        Japan (jp)
Latency                       89ms
Web Interface                 http://127.0.0.1:4040
orwarding                    https://cab0-2409-8a0c-1448-caa0-1c7b-19c6-ee43-62c3.ngrok-free.app -> http://192.168.1.222:5244 
